...
export const accountsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    deleteAccount: builder.mutation({
      ...
      invalidatesTags: ["Account", "Organization", "Unit"],
    }),
    ...
    deleteOrganization: builder.mutation({
      ...
      invalidatesTags: ["Organization", "Unit", "Account"],
    }),
