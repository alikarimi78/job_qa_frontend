...
export default function Analyze() {
  ...
  return (
    <Card
      ...
      hint="به‌جای پرسیدن یک سوال، آنچه را بلدید وارد کنید تا نزدیک‌ترین مشاغل پایگاه داده رتبه‌بندی شوند و ببینید هر شغل کدام موارد شما را پوشش می‌دهد. هر مورد را جداگانه بنویسید و با + اضافه کنید."
    >
        ...
        <form onSubmit={methods.handleSubmit(submit)} className="flex flex-col gap-4">
          ...
          <SubmitBar
            ...
            hint={
              ready
                ? undefined
                : "برای تحلیل، دست‌کم دو مهارت و در مجموع دو فیلد را پر کنید."
            }
          />
        </form>
      </FormProvider>
